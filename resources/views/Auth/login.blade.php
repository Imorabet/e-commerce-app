    ...
    <div class="relative min-h-screen flex ">
        <div
            ...
            <div class="sm:w-1/2 xl:w-3/5 h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden bg-purple-900 text-white bg-no-repeat bg-cover relative"
                style="background-image: url(https://images.pexels.com/photos/4241704/pexels-photo-4241704.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1);">
                <div class="absolute bg-gray-900 opacity-5 inset-0 z-0"></div>
                <div class="w-full  max-w-md z-10">
                    <div class="sm:text-4xl xl:text-5xl font-bold leading-tight mb-6">Welcome back to MegaShop!
                    </div>
                    <div class="sm:text-sm xl:text-lg text-gray-700 font-medium">Please login to access your account and
                        start shopping.
                    </div>
                </div>
            </div>
            <div
                class="md:flex md:items-center md:justify-center  sm:w-auto md:h-full w-2/5 xl:w-2/5 p-8  md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-gray-50 dark:bg-gray-800">
                <div class="max-w-md w-full space-y-8">
                    <div class="text-center">
                        <h2 class="mt-6 text-3xl font-bold text-gray-900 dark:text-white">
                            Welcome Back!
                        </h2>
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400 ">Please log in to your account</p>
                    </div>
                    <form class="mt-8 space-y-6" action="{{ route('login.user') }}" method="post">
                        ...
                        <div>
                            <button type="submit"
                                class="block w-full text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800 p-4 transition hover:scale-105">Login
                            </button>
                        </div>
                        <p
                            ...
                            <a href="/signup"
                                class="text-purple-400  hover:text-purple-700 no-underline hover:underline cursor-pointer transition ease-in duration-300">Sign
                                up</a>
                        </p>
                    </form>
                </div>
