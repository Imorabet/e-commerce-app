...
<body class="h-full">
                        ...
                        <li>
                            ...
                            <div id="dropdownNavbar"
                                ...
                                <ul class="py-1" aria-labelledby="dropdownLargeButton">
                                    ...
                                    <li>
                                        <a href="/admin"
                                            class="text-sm hover:bg-gray-100 text-gray-700  dark:text-gray-300 hover:text-gray-700 block px-4 py-2">Dashboard</a>
                                    </li>
                                    <li>
                                        <a href="/orders"
                                            class="text-sm hover:bg-gray-100 text-gray-700  dark:text-gray-300 hover:text-gray-700 block px-4 py-2">Your
    ...
    <section class="h-screen bg-white dark:bg-gray-900">
        <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
            @if (sizeof($orders) == 0)
                <div class="flex flex-col gap-3 py-24 justify-center items-center">
                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">No order
                        placed so far :)</h2>
                    <a href="/products"
                        class="text-gray-500 dark:text-gray-600 hover:dark:text-gray-300 hover:underline">Order
                        now</a>
                </div>
            @else
                <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">These are all
                        the
