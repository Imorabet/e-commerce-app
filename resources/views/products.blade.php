    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
            <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
                ...
                <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400"> All of our products are
                    ...
                    <form class="flex justify-center" id="search-form">
                        <label for="UserEmail" class="relative block w-full overflow-hidden border-b border-gray-200 bg-transparent pt-3 focus-within:border-purple-700 dark:border-gray-700">
                          <input type="text" id="UserEmail" placeholder="Search a product name" class="peer h-8 w-full border-none bg-transparent p-0 placeholder focus:border-transparent focus:outline-none focus:ring-0 dark:text-white sm:text-sm" />
                        </label>
            ...
            <div class="space-y-8 lg:grid lg:grid-cols-4 sm:gap-6 xl:gap-10 lg:space-y-0">
                    ...
                    <details
                        ...
                        <div class="border-t border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
                            <header class="flex items-center justify-between p-4">
                                ...
                                <button id="filterBtn" class="block w-full text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800 p-4 transition hover:scale-105">
                                    Filter
                                </button>
                ...
                <a id="{{ $product->name }}" href="#" class="group block rounded-lg overflow-hidden w-[300px]">
